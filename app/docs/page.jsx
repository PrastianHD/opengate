...
client = OpenAI(
    base_url="https://api.opengate.com/v1",
    api_key="ogt-xxx"
)
...
const client = new OpenAI({
  baseURL: "https://api.opengate.com/v1",
  apiKey: "ogt-xxx"
});
...
const CURL_SNIPPET = `curl https://api.opengate.com/v1/chat/completions \\
        ...
        <div className="docs-grid">
          ...
          <div className="docs-content">
            ...
            <div className="docs-block" id="base-url">
              ...
              <div className="code-block-wrap">
                <CopyButton text="https://api.opengate.com/v1" />
                <div className="code-block">
                  <span className="code-url">https://api.opengate.com/v1</span>
                </div>
              </div>
            </div>
