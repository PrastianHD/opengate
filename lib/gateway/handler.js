...
export async function handleChatCompletions(request) {
  ...
  if (user.balance_micro_cents <= 0) {
    ...
    return openaiError(402, {
      ...
      message: "Top up your OpenGates balance to continue",
    });
  }
  ...
  return new Response(JSON.stringify(json), {
    ...
    headers: {
      ...
      "X-OpenGates-Model": model.slug,
      "X-OpenGates-Cost-MicroCents": String(cost),
      "X-OpenGates-Balance-MicroCents": String(settled.newBalance),
    },
  });
}
